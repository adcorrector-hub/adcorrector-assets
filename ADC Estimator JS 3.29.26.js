...
function acCalculateEfficacy() {
    ...
    // 1. Apply Weighted Physics Model
    var scores = window.acLastScores;
    var wRead = (scores.readability || 0) * 0.20;
    var wCont = (scores.contrast || 0) * 0.30;
    var wClar = (scores.clarity || 0) * 0.25;
    var wComp = (scores.composition || 0) * 0.15;
    var wColo = (scores.colors || 0) * 0.10;

    var rawEfficacy = wRead + wCont + wClar + wComp + wColo;
    ...
    if (!isNaN(dec) && dec > 0) {
        ...
        decLossEl.textContent = 'Plus ~' + lostDec.toLocaleString() + ' lost daily impressions';
